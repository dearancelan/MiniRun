...
Page({
	...
	bindFormSubmit: async function () {
		...
		try {
			...
			// 创建
			let result = await cloudHelper.callCloudSumbit('mail/insert', data);
			let mailId = result.data.id;

			// 图片
			await cloudHelper.transFormsTempPics(forms, 'mail/', mailId, 'mail/update_forms');
